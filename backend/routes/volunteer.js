      ...
      */
      ...
      try {
        ...
        await sendEmail({
          ...
          subject:
            `❤️ New Volunteer Application - ${name}`,
...
Status: Pending
        ...
        console.log(
          `📧 Volunteer email sent successfully to ${recipientEmail}`
        );
        ...
        | Email Failure
        |--------------------------------------------------------------------------
        | Volunteer is already saved in MongoDB.
        | Therefore email failure should NOT
        | make the volunteer submission fail.
        |--------------------------------------------------------------------------
        */

        console.error(
          '⚠️ Volunteer email send failed:',
          emailErr.message
        );
