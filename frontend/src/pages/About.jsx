...
export default function About() {
    ...
    // Founder image
    const founderImgUrl =
        'https://i.postimg.cc/g2V8kKmC/founder-fixed-4x3.jpg';
    ...
    const valuesList = [
        {
            ...
            desc: 'Ensuring every person living with HIV is treated with unconditional respect and care.'
        },
        {
            title: 'Transparency',
            desc: 'Maintaining 100% financial and operational accountability for every donation received.'
        },
        {
            title: 'Empowerment',
            desc: 'Focusing on skill-building and education so families can become self-reliant.'
        },
        {
            title: 'Inclusivity',
            desc: 'Opening our doors to anyone in need without discrimination based on background or status.'
        }
    ];
    ...
    return (
        <section className="py-20 bg-brandNavy text-white font-body relative overflow-hidden">
                            ...
                            {activeTab === 'story' && (
                                ...
                                >
                                    <p className="text-lg font-medium text-white leading-relaxed">
                                        ...
                                        illness. Vinita gave her shelter, care, and stood by her
                                        until she rebuilt her life.
                                    </p>

                                    <p>
                                        That encounter revealed the stigma, isolation and financial
                                ...
                                >
                                    ...
                                    <div className="bg-white/5 border border-white/10 p-6 rounded-2xl hover:bg-white/10 transition-colors">
                                        ...
                                        <p className="text-white/80 leading-relaxed">
                                            To eliminate the stigma associated with HIV/AIDS,
                                            provide comprehensive medical, nutritional, and
                                            financial support to affected families, and empower
                                            women and children through sustainable education and
                                    ...
                                    <div className="bg-white/5 border border-white/10 p-6 rounded-2xl hover:bg-white/10 transition-colors">
                                        ...
                                        <p className="text-white/80 leading-relaxed">
                                            A compassionate, inclusive society where individuals
                                            and families affected by HIV/AIDS live with complete
                                            dignity, health, social acceptance, and economic
                                            independence.
                                        </p>
                        ...
                        >
                                ...
                                <div className="w-full h-72 sm:h-80 md:h-[15rem] overflow-hidden relative bg-slate-100">
                                    ...
                                    <div className="absolute bottom-3 left-4 text-white">
                                        ...
                                        <p className="text-xs text-rose-300 font-medium">
                                            Founder, Aashiana – The Shelter Trust
                                        </p>
                                    </div>
                            ...
                            <div className="p-5 sm:p-6">
                                ...
                                <blockquote className="text-xs sm:text-sm text-slate-700 italic leading-relaxed font-normal mb-4">
                                    "When I first met a young widow, abandoned with her baby,
                                    I knew I couldn’t just walk away. Aashiana was born from
                                    that moment, to stand beside those the world turns away
                                    from, until they can stand on their own."
                                </blockquote>
                ...
                <div className="pt-12 border-t border-white/10">
                    ...
                    >
                        ...
                        <p className="text-white/70 text-sm mt-2">
                            For 15 years, Aashiana has stood beside families infected &
                            affected by HIV, providing consistent nutrition, healthcare,
                            education, livelihood opportunities and emotional support.
                            What began with 20 families has grown into a community that
                            now supports more than 600 families annually.
                        </p>
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        <span className="block font-black text-2xl text-white tracking-tight mb-0.5">
                                            {item.value}
                                        </span>

                                        <span className="block font-bold text-sm text-white/90 mb-1">
                                            {item.label}
                                        </span>
